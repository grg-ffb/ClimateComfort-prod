...
const COPY = {
  en: {
    title: 'Which city are you?', docTitle: 'Which city are you? Travel personality quiz | wherefeelsgood', subtitle: 'Ten quick questions reveal your travel personality—and a city to visit.', start: 'Start the game', question: 'Question', of: 'of 10', result: 'Your city personality is…', traits: 'Your strengths', bestMonthLabel: 'Best travel month', share: 'Share with friends', shareLabel: 'Share your result', copied: 'Link copied!', instaHint: 'Link copied — paste it into Instagram.', copyFailed: 'Could not copy automatically — select the link below to copy it.', retry: 'Play again', exit: 'City finder', explore: 'Explore more cities that fit you', affiliateLabel: 'Advertisement', affiliateNote: 'Compare hotel prices with Trivago. We may earn a commission from qualified referrals at no extra cost to you.', consentText: 'We use a Trivago advertisement via Awin. With your consent, the partners may process data and set cookies to credit referrals.', consentAccept: 'Accept', consentDecline: 'Decline', faqTitle: 'Frequently asked questions about the quiz', faq: [
  ...
  de: {
    title: 'Welche Stadt bist du?', docTitle: 'Welche Stadt bist du? Reise-Quiz | wherefeelsgood', subtitle: 'Zehn einfache Fragen zeigen deine Reisepersönlichkeit – und eine Stadt für dich.', start: 'Spiel starten', question: 'Frage', of: 'von 10', result: 'Deine Stadtpersönlichkeit ist …', traits: 'Deine Stärken', bestMonthLabel: 'Bester Reisemonat', share: 'Mit Freunden teilen', shareLabel: 'Teile dein Ergebnis', copied: 'Link kopiert!', instaHint: 'Link kopiert – füge ihn in Instagram ein.', copyFailed: 'Automatisches Kopieren nicht möglich – markiere den Link unten zum Kopieren.', retry: 'Noch einmal spielen', exit: 'Stadtfinder', explore: 'Entdecke mehr Städte, die zu dir passen', affiliateLabel: 'Anzeige', affiliateNote: 'Hotelpreise mit Trivago vergleichen. Für qualifizierte Vermittlungen können wir eine Provision erhalten – ohne Mehrkosten für dich.', consentText: 'Wir verwenden eine Trivago-Anzeige über Awin. Mit deiner Einwilligung können die Partner Daten verarbeiten und Cookies zur Provisions-Zuordnung setzen.', consentAccept: 'Akzeptieren', consentDecline: 'Ablehnen', faqTitle: 'Häufige Fragen zum Reise-Quiz', faq: [

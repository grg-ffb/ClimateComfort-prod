...
function bookingUrl(city) {
  const url = new URL('https://www.booking.com/searchresults.html');
  url.searchParams.set('ss', `${city.names[lang]}, ${city.countries[lang]}`); url.searchParams.set('no_rooms', '1'); url.searchParams.set('group_adults', '2');
  return url.toString();
}
function affiliateUrl(city) {
  const destination = bookingUrl(city);
...
function openTravelLink(city) {
  window.open(affiliateUrl(city), '_blank', 'noopener');
}
const CITIES = [
...
const TEXT = {
  en: {
    ...
    quickKicker: 'One-click city finder', quickTitle: 'What matters most to you?', quickHint: 'There is no wrong choice. You can refine it afterwards.', personalize: 'Personalize my comfort', personalizeHint: 'Optional: adjust temperature, humidity, rain and walking.', resultsKicker: 'Your city matches', resultsTitle: 'Cities that could suit you', resultsHint: 'Open a city to see the best month, climate details and places to stay.', method: 'How matching works',
    ...
    why: 'Why it fits', best: 'Best matching month', day: 'Warm-day range', night: 'Night temperature', humidity: 'Humid daytime hours', rain: 'Wet days', visit: 'See accommodation options', saved: 'Your settings are saved on this device.', error: 'We could not load the climate data. Please reload the page.', score: 'Match score', showAll: 'Show all {n} cities', showLess: 'Show top 3', yearTitle: 'Your personal travel year', yearHint: 'The best-fitting city for each month, based on your profile and preferences.', consentText: 'We use partner links (via CJ Affiliate). With your consent, cookies may be set by the partner to credit referrals. No personal data is passed on by us.', consentAccept: 'Accept', consentDecline: 'Decline', seoLinksTitle: 'Popular cities & travel ideas', seoCitiesTitle: 'Popular cities', seoIdeasTitle: 'Travel ideas', seoIdeaTitles: { juli: 'Where is it not too hot in July?', august: 'Pleasant destinations in August', sommer: 'Summer holidays without heat', kuehle: 'Cool cities in Europe', beste: 'Best travel time in Europe' }, faqTitle: 'Frequently asked questions about travel climate', faq: [
      ...
      ['Where should I travel if I hate the heat?', 'The wohlfuehlreisen city finder compares 20 European cities by temperature, humidity and rain. You can see at a glance which city matches your feel-good climate in summer.'],
  ...
  de: {
    ...
    quickKicker: 'Stadtfinder mit einem Klick', quickTitle: 'Was ist dir besonders wichtig?', quickHint: 'Es gibt keine falsche Wahl. Du kannst sie anschließend verfeinern.', personalize: 'Mein Wohlfühlklima anpassen', personalizeHint: 'Optional: Temperatur, Feuchtigkeit, Regen und Bewegung einstellen.', resultsKicker: 'Deine passenden Städte', resultsTitle: 'Städte, die zu dir passen könnten', resultsHint: 'Öffne eine Stadt für Reisemonat, Klimadetails und Unterkünfte.', method: 'So funktioniert die Auswahl',
    ...
    why: 'Warum es passt', best: 'Bester Reisemonat', day: 'Warme Tagestemperatur', night: 'Nachttemperatur', humidity: 'Feuchte Tagesstunden', rain: 'Regentage', visit: 'Unterkünfte ansehen', saved: 'Deine Einstellungen werden auf diesem Gerät gespeichert.', error: 'Die Klimadaten konnten nicht geladen werden. Bitte lade die Seite neu.', score: 'Punktzahl', showAll: 'Alle {n} Städte anzeigen', showLess: 'Nur Top 3 anzeigen', yearTitle: 'Dein persönliches Reisejahr', yearHint: 'Die beste Stadt für jeden Monat, basierend auf deinem Profil und deinen Einstellungen.', consentText: 'Wir verwenden Partnerlinks (über CJ Affiliate). Mit deiner Einwilligung können Cookies des Partners zur Provisions-Zuordnung gesetzt werden. Von uns werden keine personenbezogenen Daten weitergegeben.', consentAccept: 'Akzeptieren', consentDecline: 'Ablehnen', seoLinksTitle: 'Beliebte Städte & Reiseideen', seoCitiesTitle: 'Beliebte Städte', seoIdeasTitle: 'Reiseideen', seoIdeaTitles: { juli: 'Wo ist es im Juli nicht zu heiß?', august: 'Angenehme Reiseziele im August', sommer: 'Sommerurlaub ohne Hitze', kuehle: 'Kühle Städte in Europa', beste: 'Beste Reisezeit in Europa' }, faqTitle: 'Häufige Fragen zum Reiseklima', faq: [
      ...
      ['Wohin im Sommer ohne Hitze?', 'Der wohlfuehlreisen-Stadtfinder vergleicht 20 europäische Städte nach Temperatur, Luftfeuchtigkeit und Regen. So siehst du auf einen Blick, welche Stadt im Sommer zu deinem Wohlfühl-Klima passt.'],
  ...
  es: {
    ...
    quickKicker: 'Buscador con un clic', quickTitle: '¿Qué te importa más?', quickHint: 'No hay una elección incorrecta. Puedes personalizarla después.', personalize: 'Personalizar mi comodidad', personalizeHint: 'Opcional: ajusta temperatura, humedad, lluvia y caminatas.', resultsKicker: 'Tus ciudades compatibles', resultsTitle: 'Ciudades que podrían encajar contigo', resultsHint: 'Abre una ciudad para ver el mejor mes, detalles climáticos y alojamientos.', method: 'Cómo funciona la selección',
    ...
    why: 'Por qué encaja', best: 'Mejor mes', day: 'Temperatura diurna cálida', night: 'Temperatura nocturna', humidity: 'Horas diurnas húmedas', rain: 'Días lluviosos', visit: 'Ver opciones de alojamiento', saved: 'Tus ajustes se guardan en este dispositivo.', error: 'No se pudieron cargar los datos climáticos. Vuelve a cargar la página.', score: 'Puntuación', showAll: 'Mostrar las {n} ciudades', showLess: 'Mostrar solo las 3 mejores', yearTitle: 'Tu año de viaje personal', yearHint: 'La mejor ciudad para cada mes, según tu perfil y preferencias.', consentText: 'Usamos enlaces de socios (a través de CJ Affiliate). Con tu consentimiento, el socio puede establecer cookies para acreditar referencias. Nosotros no transmitimos datos personales.', consentAccept: 'Aceptar', consentDecline: 'Rechazar', seoLinksTitle: 'Ciudades populares e ideas de viaje', seoCitiesTitle: 'Ciudades populares', seoIdeasTitle: 'Ideas de viaje', seoIdeaTitles: { juli: '¿Dónde no hace demasiado calor en julio?', august: 'Destinos agradables en agosto', sommer: 'Vacaciones de verano sin calor', kuehle: 'Ciudades frescas en Europa', beste: 'Mejor época para viajar en Europa' }, faqTitle: 'Preguntas frecuentes sobre el clima de viaje', faq: [
      ...
      ['¿Dónde viajar sin calor en verano?', 'El buscador de wohlfuehlreisen compara 20 ciudades europeas por temperatura, humedad y lluvia. Así verás de un vistazo qué ciudad se ajusta a tu clima ideal en verano.'],
...
function render() {
  ...
  visible.forEach(({ city, item, score: matchScore }, index) => {
    ...
    const book = document.createElement('button'); book.type = 'button'; book.className = 'booking-link'; book.textContent = text.visit;
    book.addEventListener('click', () => openTravelLink(city));
    content.append(title, country, description, details, book); card.append(rank, badge, content); target.append(card);
  });

...
const TEXT = {
  ...
  de: {
    ...
    why: 'Warum es passt', best: 'Bester Reisemonat', day: 'Warme Tagestemperatur', night: 'Nachttemperatur', humidity: 'Feuchte Tagesstunden', rain: 'Regentage', saved: 'Deine Einstellungen werden auf diesem Gerät gespeichert.', error: 'Die Klimadaten konnten nicht geladen werden. Bitte lade die Seite neu.', score: 'Punktzahl', showAll: 'Alle {n} Städte anzeigen', showLess: 'Nur Top 3 anzeigen', yearTitle: 'Dein persönliches Reisejahr', yearHint: 'Die beste Stadt für jeden Monat, basierend auf deinem Profil und deinen Einstellungen.', affiliateLabel: 'Anzeige', affiliateNote: 'Hotelpreise mit Trivago vergleichen. Für qualifizierte Vermittlungen können wir eine Provision erhalten – ohne Mehrkosten für dich.', consentText: 'Wir verwenden eine Trivago-Anzeige über Awin. Mit deiner Einwilligung können die Partner Daten verarbeiten und Cookies zur Provisions-Zuordnung setzen.', consentAccept: 'Akzeptieren', consentDecline: 'Ablehnen', seoLinksTitle: 'Beliebte Städte & Reiseideen', seoCitiesTitle: 'Beliebte Städte', seoIdeasTitle: 'Reiseideen', seoIdeaTitles: { juli: 'Wo ist es im Juli nicht zu heiß?', august: 'Angenehme Reiseziele im August', sommer: 'Sommerurlaub ohne Hitze', kuehle: 'Kühle Städte in Europa', beste: 'Beste Reisezeit in Europa' }, faqTitle: 'Häufige Fragen zum Reiseklima', faq: [
